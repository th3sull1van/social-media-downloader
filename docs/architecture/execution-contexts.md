...
| **Offscreen Document** | Dedicated document | Limited (`runtime.sendMessage`) | Background on-demand | Memory-safe JSZip packaging in `STORE` mode with 1GB guard ceiling |
