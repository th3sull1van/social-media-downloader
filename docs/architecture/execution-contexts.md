...
| **Offscreen Document** | Dedicated document | Limited (`runtime.sendMessage`) | Background on-demand | Memory-safe ZIP packaging in `STORE` mode with 1GB guard ceiling (hand-written engine) |
