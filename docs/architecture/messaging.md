...
- Offscreen ZIP: `OFFSCREEN_BEGIN_ZIP`, `OFFSCREEN_ADD_FILE`, `OFFSCREEN_FINISH_ZIP`,
  `OFFSCREEN_ABORT_ZIP`, `OFFSCREEN_CREATE_BLOB_URL`, `OFFSCREEN_REVOKE_BLOB_URLS`,
  `ZIP_OFFSCREEN_PROGRESS`.
