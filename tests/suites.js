...
import { runGridPerformanceTests } from './core/grid-performance.test.js';
...
export const suites = [
  ...
  { id: 'grid-performance', name: 'Incremental Grid Rendering & Large Galleries', fn: runGridPerformanceTests },
